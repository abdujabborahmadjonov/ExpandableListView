...
class ExpandetAdapter(var titleList: List<String>, var map: HashMap<String, ArrayList<String>>) :
    ...
    override fun getGroupView(
        ...
        var groupItemView:View = convertView ?: LayoutInflater.from(parent?.context).inflate(R.layout.item_group, parent, false)

        groupItemView.txt_ism.text = titleList[groupPosition]
